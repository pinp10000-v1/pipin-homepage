            ...
            >
              {portfolioProjects.map((project) => (
                <div key={project.name} className="flex-shrink-0">
                  <div className="relative h-48 w-full overflow-hidden bg-gradient-to-br from-white/10 to-white/5 mb-4 flex items-center justify-center">
                    <Image
                      src={project.image}
                      alt={project.name}
                      fill
                    ...
                    />
                    <div className="absolute inset-0 flex items-center justify-center opacity-30 text-white/50 text-center p-4">
