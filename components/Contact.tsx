      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10" ref={ref}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-5 reveal">
            <p className="text-xs font-semibold tracking-[0.3em] text-teal uppercase mb-6">
              LET'S PARTNER UP
            </p>
            <h2 className="text-4xl md:text-6xl font-black text-navy leading-[1.1] mb-8">
              당신의 성공을<br />
              <span className="text-teal">함께 설계</span>합니다
            </h2>
            <p className="text-gray-500 text-lg leading-relaxed mb-12">
              사업지 검토 문의부터 마케팅 전략 수립까지,<br className="hidden md:block" />
              피플인피플의 전문가 그룹이 직접 답변해 드립니다.
            </p>

            {/* Premium Tip Box - Repositioned to Top */}
            <div className="p-8 bg-surface border-l-4 border-teal relative shadow-sm">
              ...
              <ul className="text-sm text-gray-600 space-y-4 leading-relaxed font-medium">
                <li className="flex items-start gap-3">
                  <span className="text-teal font-black">01</span> 
                  <span>사업지 위치 및 대략적인 면적</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal font-black">02</span> 
                  <span>예정 상품 유형 (아파트/오피스텔 등)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal font-black">03</span> 
                  <span>현재 사업 진행 단계</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal font-black">04</span> 
          ...
          <div className="lg:col-span-7 reveal" style={{ transitionDelay: '200ms' }}>
            <div className="bg-white shadow-2xl p-8 md:p-12 border border-gray-100 relative">
              {submitted ? (
                <div className="py-20 flex flex-col items-center justify-center text-center animate-fade-in">
                  ...
                  <button 
                    ...
                    className="mt-10 text-teal font-bold text-sm border-b-2 border-teal pb-1 hover:text-navy hover:border-navy transition-all"
                  >
                    추가 문의하기
                  </button>
                </div>
