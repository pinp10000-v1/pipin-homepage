          ...
          {services.map((service, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-6xl font-black text-gray-100 group-hover:text-teal/15 transition-colors leading-none select-none" aria-hidden="true">{service.num}</span>
              </div>
